        ...
        <div className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="card flex items-center gap-4">
                    ...
                    <div>
                        <div className="text-slate-500 text-sm font-medium">ตั๋วเรือที่ขายวันนี้</div>
                        <div className="text-3xl font-bold text-slate-800">{stats.ticketsSoldToday}</div>
                    </div>
                </div>
                ...
                <div className="card flex items-center gap-4">
                    ...
                    <div>
                        <div className="text-slate-500 text-sm font-medium">พัสดุรับฝากวันนี้</div>
                        <div className="text-3xl font-bold text-slate-800">{stats.parcelsdepositedToday}</div>
                    </div>
                </div>
                ...
                <div className="card flex items-center gap-4">
                    ...
                    <div>
                        <div className="text-slate-500 text-sm font-medium">รายได้วันนี้</div>
                        <div className="text-3xl font-bold text-slate-800">{stats.totalRevenue} THB</div>
                    </div>
                </div>
                ...
                <div className="card flex items-center gap-4">
                    ...
                    <div>
                        <div className="text-slate-500 text-sm font-medium">พัสดุรอส่ง</div>
                        <div className="text-3xl font-bold text-slate-800">{stats.parcelsWaiting}</div>
                    </div>
                </div>
            </div>
                        ...
                        <table className="w-full text-sm text-left">
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {stats.recentTickets?.length === 0 ? (
                                    <tr><td colSpan="4" className="p-4 text-center text-slate-400">ยังไม่มีการขายวันนี้</td></tr>
                                    ...
                                    <tr key={ticket.id} className="hover:bg-slate-50">
                                        ...
                                        <td className="p-3 text-right font-medium">{ticket.price}</td>
                                        <td className="p-3 text-slate-500">{ticket.seller?.name}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                        ...
                        <table className="w-full text-sm text-left">
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {stats.recentParcels?.length === 0 ? (
                                    <tr><td colSpan="4" className="p-4 text-center text-slate-400">ยังไม่มีการฝากวันนี้</td></tr>
                                ) : stats.recentParcels?.map(parcel => (
                                    <tr key={parcel.id} className="hover:bg-slate-50">
                                        <td className="p-3 font-mono text-slate-600">
                                            {format(new Date(parcel.createdAt), 'HH:mm')}
                                        </td>
                                        <td className="p-3 font-medium">{parcel.senderName}</td>
                                        <td className="p-3 text-right font-medium">{parcel.price}</td>
